...
// test("test2048BitDivision", () => {
//   const a = ""
//   const b = "5";
//   const aBigInt = stringToBigint(a);
//   const bBigInt = stringToBigint(b);
//   const result = bigintModArith.div(aBigInt, bBigInt);
//   console.log(`${getTimestamp()} Result: ${result}`);
// });
